"""
Django settings for hhfghg_241 project.
...
WSGI_APPLICATION = 'hhfghg_241.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hhfghg_241 API",
    "DESCRIPTION": "API documentation for hhfghg_241 App",
    "VERSION": "v1",
}
